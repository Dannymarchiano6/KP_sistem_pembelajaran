...
class CourseScreenbab1 extends StatefulWidget {
  String img;
  CourseScreenbab1(this.img);
  @override
  State<CourseScreenbab1> createState() => _CourseScreenState();
}

class _CourseScreenState extends State<CourseScreenbab1> {
